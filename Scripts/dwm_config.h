...
static const char col_1[]  = "#000000"; /* background color of bar, original: #282c34*/
static const char col_2[]  = "#282c34"; /* border color unfocused windows */
static const char col_3[]  = "#d7d7d7";
static const char col_4[]  = "#f90"; /* border color focused windows and tags, original: #924441*/
/* bar opacity 
...
static Key keys[] = {
	...
	{ MODKEY,        	XK_x,      spawn,          CMD("i3lock -i /home/redouane/Pictures/white_lion_cub-1366x768.png") },
	{ MODKEY,        	XK_t,      spawn,          CMD("sh -c /home/redouane/Downloads/tor-browser_en-US/Browser/start-tor-browser") },

	{ MODKEY|ShiftMask,     XK_s,      spawn,          CMD("sh -c /home/redouane/Scripts/shutdown.sh") },
	{ MODKEY,      		XK_s,      spawn,          CMD("sh -c /home/redouane/Scripts/reboot.sh") },

    /* Multimedia keybindings */
	{ 0,        XF86XK_MonBrightnessUp,      spawn,    CMD("xbacklight -inc 10") },
	{ 0,        XF86XK_MonBrightnessDown,    spawn,    CMD("xbacklight -dec 10") },
	{ 0,        XF86XK_AudioRaiseVolume,     spawn,    CMD("pactl set-sink-volume @DEFAULT_SINK@ +10%") },
	{ 0,        XF86XK_AudioLowerVolume,     spawn,    CMD("pactl set-sink-volume @DEFAULT_SINK@ -10%") },
	{ 0,        XF86XK_AudioMute,            spawn,    CMD("pactl set-sink-mute @DEFAULT_SINK@ toggle") },
	{ 0,        XF86XK_AudioMicMute,         spawn,    CMD("pactl set-source-mute @DEFAULT_SOURCE@ toggle") },
